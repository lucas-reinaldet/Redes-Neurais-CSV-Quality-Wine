...
caminho = "wine/winequality-red.csv"
...
train_labels = to_categorical(train_set['quality'])
test_labels = to_categorical(test_set['quality'])

train_set =  train_set.drop(columns=['quality'])
test_set =  test_set.drop(columns=['quality'])
